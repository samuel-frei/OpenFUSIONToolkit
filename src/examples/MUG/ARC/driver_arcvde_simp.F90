...
equil%pnorm = .8570289679065064
equil%alam = 15.083063976698954  
...
equil%cond_regions(1)%eta = 1.27482d-6/mu0
equil%cond_regions(2)%id = 4
equil%cond_regions(2)%eta = 2.96d-6/mu0
equil%cond_regions(3)%id = 5
equil%cond_regions(3)%eta = 0.005d0/mu0

ALLOCATE(equil%coil_regions(equil%ncoil_regs))
ALLOCATE(equil%coil_currs(equil%ncoil_regs))
equil%coil_currs = [-378924.5491377952, -379748.97502163716, 140689.27523198974, 140987.65270833066, 167546.72586986047, 168291.68162699795, 195554.54156318933, 195646.07250171853, 13581.53326060549, 12921.540827051069, 75180.32601046325, 75312.32487082492, -95493.6245234414, -95598.54618345674, -17665.939312559072, -17640.493045227166]*mu0
...
eta_reg = 1.d-2/mu0
! eta_reg(3) = 1.27482d-6/mu0
! eta_reg(4) = 2.96d-6/mu0
eta_reg(3) = 1.27482d-6/(1.65*mu0)
eta_reg(4) = 2.96d-6/(1.65*mu0)
...
! CALL gs_td%rst_load(gs_td%u,'gs_xmhd_00031.rst', 'U')
! gs_td%rst_base = 31
