...
USE oft_gs_td, ONLY: setup_gs_td, step_gs_td, oft_tmaker_td
...
TYPE(oft_tmaker_td), TARGET :: gs_td
!---Runtime options
INTEGER(i4) :: order = 2
...
!---------------------------------------------------------------------------
CALL gs_td%setup(equil,1.d-3,1.d-13,1.d-11,.FALSE.)

CALL gs_td%step(t,dt, nl_its, l_its, nretry)
! t = t + dt
! CALL gs_td%step(t,dt, nl_its, l_its, nretry)
! t = t + dt
! CALL gs_td%step(t,dt, nl_its, l_its, nretry)
