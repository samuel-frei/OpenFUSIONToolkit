...
CHARACTER(LEN=25) :: filename_eddy_mid= 'psi_plasma_dis.h5' !< Name of input file for mesh, fix later for variable length
CHARACTER(LEN=25) :: filename_plasma_mid= 'psi_eddy_dis.h5' !< Name of input file for mesh, fix later for variable length
...
equil%pnorm = 2.3853705619634225d-05
equil%alam = 9.7835990882251949 
...
CALL gs_td%rst_load(gs_td%u,'mid_dis.rst', 'U')
NULLIFY(tmp_arr)
