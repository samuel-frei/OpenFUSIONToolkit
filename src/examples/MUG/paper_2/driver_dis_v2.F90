...
TYPE(gs_j_interp), TARGET:: j_interp
...
!------------------------------------------------------
!-------------SWITCH MODES TO FLUX QUENCHING--------
!------------------------------------------------------
CALL j_interp%setup(gs_td%eq)
gs_td%j_source => j_interp
gs_td%j_source_scale = 1.d0 
...
!     gs_td%j_source_scale = 1.d0-0.1d0*i
!   ELSE
