...
REAL(r8) :: t = 0.d0
REAL (r8):: ip_ratio_target = 0.01
REAL (r8):: ip_target = 7.87E6
REAL(r8), allocatable, dimension(:) :: psi_eq, psi_pert, psi_total, eta_reg,curr_reg, areas
REAL (r8):: coords(3)
LOGICAL :: pm=.TRUE.
LOGICAL :: success
CHARACTER(LEN=25) :: filename_eq = 'paper_eq_0105.h5' !< Name of input file for mesh, fix later for variable length
CHARACTER(LEN=25) :: filename_pert= 'paper_pert_0105.h5' !< Name of input file for mesh, fix later for variable length
...
equil%pnorm = 0.34178090136168576
equil%alam = 0.15137078284461516
...
equil%coil_currs = [-10004132.06910441, 7893717.029603205, 7892985.209467789, -2623091.2355761332, -2623820.9081637934, -1598656.3896347948, -1599202.1011763492]*mu0
